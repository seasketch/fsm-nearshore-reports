...
export async function lamotrekOusDemographics(
  sketch:
  ...
  // Load OUS shapes
  const url = `${projectClient.dataBucketUrl()}lamotrekOusDemographics.fgb`;
...
export default new GeoprocessingHandler(lamotrekOusDemographics, {
  title: "lamotrekOusDemographics",
