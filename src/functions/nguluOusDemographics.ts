...
export async function nguluOusDemographics(
  sketch:
  ...
  // Load OUS shapes
  const url = `${projectClient.dataBucketUrl()}nguluOusDemographics.fgb`;
...
export default new GeoprocessingHandler(nguluOusDemographics, {
  title: "nguluOusDemographics",
