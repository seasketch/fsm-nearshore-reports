...
export async function ulithiOusDemographics(
  sketch:
  ...
  // Load OUS shapes
  const url = `${projectClient.dataBucketUrl()}ulithiOusDemographics.fgb`;
...
export default new GeoprocessingHandler(ulithiOusDemographics, {
  title: "ulithiOusDemographics",
