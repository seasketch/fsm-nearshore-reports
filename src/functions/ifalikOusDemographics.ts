...
export async function ifalikOusDemographics(
  sketch:
  ...
  // Load OUS shapes
  const url = `${projectClient.dataBucketUrl()}ifalikOusDemographics.fgb`;
...
export default new GeoprocessingHandler(ifalikOusDemographics, {
  title: "ifalikOusDemographics",
