...
export async function elatoOusDemographics(
  sketch:
  ...
  // Load OUS shapes
  const url = `${projectClient.dataBucketUrl()}elatoOusDemographics.fgb`;
...
export default new GeoprocessingHandler(elatoOusDemographics, {
  title: "elatoOusDemographics",
