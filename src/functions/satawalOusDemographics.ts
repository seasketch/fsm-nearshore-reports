...
export async function satawalOusDemographics(
  sketch:
  ...
  // Load OUS shapes
  const url = `${projectClient.dataBucketUrl()}satawalOusDemographics.fgb`;
...
export default new GeoprocessingHandler(satawalOusDemographics, {
  title: "satawalOusDemographics",
