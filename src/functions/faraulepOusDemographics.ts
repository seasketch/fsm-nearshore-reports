...
export async function faraulepOusDemographics(
  sketch:
  ...
  // Load OUS shapes
  const url = `${projectClient.dataBucketUrl()}faraulepOusDemographics.fgb`;
...
export default new GeoprocessingHandler(faraulepOusDemographics, {
  title: "faraulepOusDemographics",
