...
import precalcTotals from "../../data/bin/satawalPrecalc.json" with { type: "json" };
...
export const SatawalOusDemographics: React.FunctionComponent<ReportProps> = (
  props,
) => {
  const { t } = useTranslation();

  const overallMg = project.getMetricGroup("satawalOusOverallDemog", t);
  const sectorMg = project.getMetricGroup("satawalOusSectorDemog", t);
  const gearMg = project.getMetricGroup("satawalOusGearDemog", t);
  ...
  return (
    <div style={{ breakInside: "avoid" }}>
      <ResultsCard
        ...
        functionName="satawalOusDemographics"
        extraParams={{
