...
import precalcTotals from "../../data/bin/nguluPrecalc.json" with { type: "json" };
...
export const NguluOusDemographics: React.FunctionComponent<ReportProps> = (
  props,
) => {
  const { t } = useTranslation();

  const overallMg = project.getMetricGroup("nguluOusOverallDemog", t);
  const sectorMg = project.getMetricGroup("nguluOusSectorDemog", t);
  const gearMg = project.getMetricGroup("nguluOusGearDemog", t);
  ...
  return (
    <div style={{ breakInside: "avoid" }}>
      <ResultsCard
        ...
        functionName="nguluOusDemographics"
        extraParams={{
