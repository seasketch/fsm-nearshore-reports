...
import precalcTotals from "../../data/bin/lamotrekPrecalc.json" with { type: "json" };
...
export const LamotrekOusDemographics: React.FunctionComponent<ReportProps> = (
  props,
) => {
  const { t } = useTranslation();

  const overallMg = project.getMetricGroup("lamotrekOusOverallDemog", t);
  const sectorMg = project.getMetricGroup("lamotrekOusSectorDemog", t);
  const gearMg = project.getMetricGroup("lamotrekOusGearDemog", t);
  ...
  return (
    <div style={{ breakInside: "avoid" }}>
      <ResultsCard
        ...
        functionName="lamotrekOusDemographics"
        extraParams={{
