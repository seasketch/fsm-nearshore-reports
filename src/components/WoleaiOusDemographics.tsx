...
export const WoleaiOusDemographics: React.FunctionComponent<ReportProps> = (
  props,
) => {
  const { t } = useTranslation();

  const overallMg = project.getMetricGroup("woleaiOusOverallDemog", t);
  const sectorMg = project.getMetricGroup("woleaiOusSectorDemog", t);
  const islandMg = project.getMetricGroup("woleaiOusIslandDemog", t);
  const gearMg = project.getMetricGroup("woleaiOusGearDemog", t);
  ...
  return (
    <div style={{ breakInside: "avoid" }}>
      <ResultsCard
        ...
        functionName="woleaiOusDemographics"
        extraParams={{
