...
import precalcTotals from "../../data/bin/ifalikPrecalc.json" with { type: "json" };
...
export const IfalikOusDemographics: React.FunctionComponent<ReportProps> = (
  props,
) => {
  const { t } = useTranslation();

  const overallMg = project.getMetricGroup("ifalikOusOverallDemog", t);
  const sectorMg = project.getMetricGroup("ifalikOusSectorDemog", t);
  const gearMg = project.getMetricGroup("ifalikOusGearDemog", t);
  ...
  return (
    <div style={{ breakInside: "avoid" }}>
      <ResultsCard
        ...
        functionName="ifalikOusDemographics"
        extraParams={{
