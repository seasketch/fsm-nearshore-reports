...
export const EauripikOus: React.FunctionComponent<ReportProps> = (props) => {
  const [{ isCollection, childProperties }] = useSketchProperties();
  const { t } = useTranslation();
  const mg = project.getMetricGroup("eauripikOus", t);
            ...
            <>
              ...
              {!props.printing && (
                <Collapse title={t("Learn more")}>
                  <Trans i18nKey="U OUS Card - learn more">
                    <p>
