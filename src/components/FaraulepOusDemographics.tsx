...
import precalcTotals from "../../data/bin/faraulepPrecalc.json" with { type: "json" };
...
export const FaraulepOusDemographics: React.FunctionComponent<ReportProps> = (
  props,
) => {
  const { t } = useTranslation();

  const overallMg = project.getMetricGroup("faraulepOusOverallDemog", t);
  const sectorMg = project.getMetricGroup("faraulepOusSectorDemog", t);
  const islandMg = project.getMetricGroup("faraulepOusIslandDemog", t);
  const gearMg = project.getMetricGroup("faraulepOusGearDemog", t);
  ...
  return (
    <div style={{ breakInside: "avoid" }}>
      <ResultsCard
        ...
        functionName="faraulepOusDemographics"
        extraParams={{
        ...
        {(data: ReportResult) => {
          ...
          return (
            <>
              ...
              <Collapse title={t("Show by Island")}>
                <p>
