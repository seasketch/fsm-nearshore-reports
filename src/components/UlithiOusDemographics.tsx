...
import precalcTotals from "../../data/bin/ulithiPrecalc.json" with { type: "json" };
...
export const UlithiOusDemographics: React.FunctionComponent<ReportProps> = (
  props,
) => {
  const { t } = useTranslation();

  const overallMg = project.getMetricGroup("ulithiOusOverallDemog", t);
  const sectorMg = project.getMetricGroup("ulithiOusSectorDemog", t);
  const islandMg = project.getMetricGroup("ulithiOusIslandDemog", t);
  const gearMg = project.getMetricGroup("ulithiOusGearDemog", t);
  ...
  return (
    <div style={{ breakInside: "avoid" }}>
      <ResultsCard
        ...
        functionName="ulithiOusDemographics"
        extraParams={{
