...
import {
  ...
  OusStats,
} from "../../src/functions/yapOusDemographics.js";

const DEST_PATH = "yapOusDemographicPrecalcTotals.json";
...
async function main() {
    ...
    (statsSoFar: OusStats, shape: OusFeature) => {
      ...
      if (!respondentProcessed[resp_id]) {
        ...
        newStats.byMunicipality[municipality] = newStats.byMunicipality[
          ...
          ? newStats.byMunicipality[municipality] + overallPeople
          : overallPeople;
  ...
  const municipalityMetrics = genOusClassMetrics(countStats.byMunicipality);
  ...
  const ousOverallDemographicOverlap: MetricGroup = {
    metricId: "yapOusOverallDemographicOverlap",
    type: "countOverlap",
  ...
  const ousSectorDemographicOverlap: MetricGroup = {
    metricId: "yapOusSectorDemographicOverlap",
    type: "countOverlap",
  ...
  const ousMunicipalityClasses: DataClass[] = Object.keys(
    finalMetrics.stats.byMunicipality,
  )
  ...
  const ousCommunityDemographicOverlap: MetricGroup = {
    metricId: "yapOusMunicipalityDemographicOverlap",
    type: "countOverlap",
  ...
  const ousGearDemographicOverlap: MetricGroup = {
    metricId: "yapOusGearDemographicOverlap",
    type: "countOverlap",
