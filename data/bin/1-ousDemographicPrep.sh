...
ogr2ogr -t_srs "EPSG:4326" -f GeoJSON -nlt PROMOTE_TO_MULTI -wrapdateline -dialect OGRSQL -sql "select kosrae_scrubbed_shapes.anon_id as resp_id, kosrae_scrubbed_shapes.gender as gender, kosrae_scrubbed_shapes.fish_method as gear, kosrae_scrubbed_shapes.kosrae_mun as municipality, kosrae_scrubbed_shapes.value as weight, kosrae_scrubbed_shapes.sector as sector, kosrae_scrubbed_shapes.individuals_represented as number_of_ppl from kosrae_scrubbed_shapes" ../src/Data_Products/data_packages/kosrae_data_package/ous_demographics.geojson ../src/Data_Products/data_packages/kosrae_data_package/kosrae_scrubbed_shapes.geojson
